...
/// ════════════════════════════════════════════════════════════════════════════
///
/// Hive es una base de datos NoSQL muy rápida y eficiente para Flutter.
///
/// ✓ CARACTERÍSTICAS:
///   • Base de datos key-value embebida
///   • Muy rápido (codificado en Dart)
///   • Soporte para objetos complejos
///   • Ideales para caché y datos secundarios
...
///   • Favoritos
///   • Carrito de compras
///   • Cambios locales antes de sincronizar
///   • Datos que cambian frecuentemente
///
/// ✓ COMPARACIÓN CON OTROS:
///   • vs SharedPreferences: Hive es más rápida y soporta objetos complejos
///   • vs SQLite: Hive es más rápida pero menos poderosa para queries complejas
///   • vs Archivos: Hive acceso más rápido, archivos para exportación
/// ════════════════════════════════════════════════════════════════════════════
